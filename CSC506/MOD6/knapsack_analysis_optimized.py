...
def knapsack_dp_2d(items, capacity):
    ...
    # very rough memory estimate: ints as Python objects vary, but give byte count for table cells (lower bound)
    table_cells = (n + 1) * (capacity + 1)
    # assume 28 bytes per small int object typical on CPython 64-bit (approx; this is illustrative)
...
if __name__ == "__main__":
    ...
    print_divider("FIGURE 1: Runtime Comparison (avg seconds over 5 runs)")
